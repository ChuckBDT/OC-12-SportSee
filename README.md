...
The landing page is http://localhost:3000, you'll need to reach the end point /users/id. So to see the real page, you need to go to http://localhost:3000/users/{id}.

Two ids are available from the API : 12 & 18.
